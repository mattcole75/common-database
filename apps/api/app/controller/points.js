const repo = require('../repository/points');
const axios = require('../../axios/auth');
const log = require('../../logs/logger')();
const config = require('../../config/config');
const version = config.get('version');
const validate = require('../../data/validation/validate');
const { postPointMachineSwingTimeSchema, getPointMachineSwingTimesSchema, postSensorMonitoringPointSchema } = require('../../data/validation/schema/pointsSchema');
